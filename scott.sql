...
INSERT INTO TBL_NOTNULL VALUES('TESTID1', NULL, '010-1234-1234');
INSERT INTO TBL_NOTNULL VALUES('TESTID1', 'TESTID1', NULL);


SELECT * FROM TBL_NOTNULL 

SELECT * FROM TBL_NOTNULL2 
...
UNIQIE : 지정한 열이 유리한 값을 가져야 함 (NULL은 중복시 따지지 않음)
-- ID , EMAIL, 주민등록번호, 전화번호 
...
INSERT INTO TBL_UNIQUE  VALUES('TESTID1', 'TESTID1', 010-1234-1234 );

SELECT * FROM TBL_UNIQUE ;

CREATE TABLE TBL_UNIQUE2(
LOGIN_ID VARCHAR2(20) CONSTRAINT TBL_ID_UNQ UNIQUE,
LOGIN_PWD VARCHAR2(20) CONSTRAINT TBL_PWD_UNQ NOT NULL,
TEL VARCHAR2(20));

ALTER TABLE TBL_UNIQUE2 MODIFY (TEL UNIQUE)

ALTER TABLE TBL_UNIQUE2 DROP CONSTRAINT TBL_ID_UNQ

무결성 제약 조건(SCOTT.SYS_C008361)에 위배됩니다
-- 데이터 무결성 : 데이터의 정확성, 일관성을 보장해야함.


PRIMARY KEY(PK , 기본키) : 지정한 열이 유일한 값이면서 NULL을 허용하지 않음 (테이블당 하나만 지정)
-- 인덱스 설정 자동으로 만들어짐 
-- NOT NULL + UNUQUE  : 회원 아이디, 이메일, 상품코드, 글번호 . . . . .
...
INSERT INTO TBL_PRIMARY(LOGIN_ID, LOGIN_PWD, TEL) VALUES 
('', 'TESEPWD1', '01012341234');

SELECT * FROM TBL_PRIMARY ;



FOREIGN KEY(FK, 외래키) : 특정 테이블의 기본키로 지정한 열을 다른 테이블의 특정 열에서 참조 

CREATE TABLE DEPT_FK(DEPTNO NUMBER(2) CONSTRAINT DEPTFK_DEPTNO_PK PRIMARY KEY,
DANME VARCHAR2(20), LOC VARCHAR2(20));
 

CREATE TABLE EMP_FK (EMPNO NUMBER (4) CONSTRAINT EMPFK_EMPNO_PK PRIMARY KEY, ENAME VARCHAR (10), JOB VARCHAR(9), MGR NUMBER(4), HIREDATE DATE, SAL NUMBER(7,2) , 
COMM NUMBER(7,2) , DEPTNO NUMBER (2) CONSTRAINT EMPFK_DEPTNO_FK REFERENCES DEPT_FK(DEPTNO));


- 부모 키가 없습니다 - 부모 먼저 만들어야함 
...
자식 레코드가 발견되었습니다 - 자식 먼저 없애야함 
DELETE FROM DEPT_FK WHERE DEPTNO = 50;


1) ON DELETE CACCADE : 부모가 삭제되면 자식도 같이 삭제 
...
COMM NUMBER(7,
2) ,
DEPTNO NUMBER (2) CONSTRAINT EMPFK3_DEPTNO_FK REFERENCES DEPT_FK(DEPTNO)
ON DELETE SET NULL);
...
INSERT INTO TBL_DEFAULT VALUES ('TESTID1', '2222', NULL);

INSERT INTO TBL_DEFAULT (LOGIN_ID,TEL) VALUES ('TESTID2', '010-1234-1234');
...
CREATE TABLE JJ_UC(
JJ_CODE NUMBER (4) CONSTRAINT JJ_UC_CODE PRIMARY KEY,
JJ_NAME VARCHAR2 (15) , JJ_TEL VARCHAR2 (20), JJ_LOC VARCHAR2 (10), JJ_DD VARCHAR2 (10));



CREATE TABLE JJ_SP(
JJ_SP_CODE NUMBER (5) CONSTRAINT JJ_SP_CODE PRIMARY KEY,
JJ_CODE NUMBER (4) CONSTRAINT JJ_UCCODE_FK REFERENCES JJ_UC(JJ_CODE),
JJ_SP_NAME VARCHAR2 (15) , JJ_SP_S NUMBER (20), JJ_DATE DATE  , JJ_GGR NUMBER (10));

CREATE SEQUENCE JJ_UCCODE_FK
...
JJ_CODE NUMBER (4) CONSTRAINT JJ_UCCODE_FK2 REFERENCES JJ_UC(JJ_CODE),
JJ_SP_CODE NUMBER (4) CONSTRAINT JJ_SP_CODE_FK REFERENCES JJ_SP(JJ_SP_CODE),
LOC2 VARCHAR(20) , BUY_DATE DATE , BUY_R NUMBER(20));

RENAME JJ_ORDER TO ORDER;
...
VALUES ('kim1231', 'kim1231', '김지호', 20);



CREATE TABLE WRITE (
WR_NUMB NUMBER (30) PRIMARY KEY,
USERID VARCHAR2 (20) CONSTRAINT JJ_USERID REFERENCES MEMBER(USERID),
WR_NY VARCHAR (30) NOT NULL,
WR_DAT DATE NOT NULL )

CREATE SEQUENCE WR_NUMB;
